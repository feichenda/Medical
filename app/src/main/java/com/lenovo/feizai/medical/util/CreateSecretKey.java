...
//        return (new BASE64Encoder()).encodeBuffer(key);
    ...
    public static void main(String[] args) {
        ...
        String input =
                "你好，涂鸦胆红素的虎视眈眈就是v苯甲酸钠都是你的事是你的三大数据百年大计你仿佛胡恩方式等你发的那份思念的苏丹诺夫江苏省今年房价能否飞鸟时代难舍难分u我的服务i发女生的烦恼设计大师的军事基地杀害的撒或多或少的哈设计大师大师大师好的环境好嗲水滴石穿八九你说的哈是的哈比的胡说八道好吧华盛顿哈就到脚抽筋啊谁都难受";
        ...
        try {
            ...
            String base64 = encryptBASE64(signature);
